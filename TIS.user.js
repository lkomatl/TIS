...
(function() {
var zvukosnov = "1";  //основное звуковое сопровождение, по умолчанию
var zvukSled = "1";
...
var tosnowcleaner = thsnowcleaner + tmsnowcleaner  + tssnowcleaner;
   ...
   if (localStorage["pernatskTIS.zvukSled"] == "1" ){
    //снежный городок
if(document.getElementById('mini-content-timer-snowtown') !== null){
var snowtown=document.getElementById('mini-content-timer-snowtown');
var tsnowtown=snowtown.innerHTML; //достаём и коверкаем таймер

//var thsnowtown = thsnowtown.substring(0, tsnowsnowtown.length - 6);
var tmsnowtown = tsnowtown.substring(0, tsnowtown.length - 3);
var tssnowtown = tsnowtown.substring(3);
    if (tssnowtown < poltaim ){tssnowtown = 0;}
    else {tssnowtown = tssnowtown - poltaim;}
        //таймер
//thsnowcleaner = thsnowcleaner * 3600000;
tmsnowtown= tmsnowtown * 60000;
 tssnowtown = tssnowtown * 1000;
var tosnowtown =  tmsnowtown  + tssnowtown;
   setTimeout(function() {audioSled.play()}, tosnowtown);
}}
